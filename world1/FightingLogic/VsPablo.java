...
public class VsPablo extends PlayerVsOpponent{
    static Player player = GameLogic.player;

    public VsPablo(Player play, StreetFighter opponent){
        super(player, opponent);
    }

    @Override
    protected String[] getOpponentAttacks() {
        return PabloUrbanGym.opponentAttacks;
    }
    ...
    protected void opponentPerformAction(int choice) {
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                if (opponent.hasEnoughStamina(7)) opponent.jabToTheBody();
                break;
            case 5:
